...
namespace Latihan_POS.Class
{
    class clsSupplier
    {
        private static string nama_tabel = "supplier";
        ...
        public clsSupplier(int id, string nama,string alamat, string zip_code,string phone_number, string email,DateTime created_at, DateTime updated_at)
        {
            this.id = id;
            this.nama = nama;
            this.alamat = alamat;
        ...
        // EDIT
        public clsSupplier(int id, string nama,string alamat, string zip_code,string phone_number, string email, DateTime updated_at)
        {
            this.id = id;
            this.nama = nama;
            this.alamat = alamat;
        ...
        // INSERT
        public clsSupplier(string nama,string alamat, string zip_code,string phone_number, string email,DateTime created_at, DateTime updated_at)
        {
        ...
        public static clsSupplier Search(string id_search)
        {
            ...
            try
            {
                ...
                if (dtc.Rows.Count == 1)
                {
                    clsSupplier supp = new clsSupplier(Convert.ToInt32(dtc.Rows[0][0].ToString()), dtc.Rows[0][1].ToString(), dtc.Rows[0][2].ToString(), dtc.Rows[0][3].ToString(), dtc.Rows[0][4].ToString(), dtc.Rows[0][5].ToString(), Convert.ToDateTime(dtc.Rows[0][6]), Convert.ToDateTime(dtc.Rows[0][7]));    
                    return supp;
                }
                return null;
            }
